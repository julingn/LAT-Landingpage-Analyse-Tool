...
// ── Prompts ──────────────────────────────────────────────────────────────
$systemPrompt = require __DIR__ . '/../prompts/pv.php';
// Override aus KI-Agenten-Verwaltung (settings.json: agent_prompt_pv)
$agentOverride = trim((string) cfg('LAT_AGENT_PROMPT_PV', 'agent_prompt_pv', ''));
